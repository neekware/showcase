...
import { Icon, mdiChevronDown } from '@lib/ui-icon-next';
import { cn, cva } from '@lib/ui-util-next';
...
const navigationMenuTriggerStyle = cva(
  'group inline-flex h-10 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium transition-colors hover:bg-tertiary hover:text-tertiary-foreground focus:bg-tertiary focus:text-tertiary-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-tertiary/50 data-[state=open]:bg-tertiary/50'
);
