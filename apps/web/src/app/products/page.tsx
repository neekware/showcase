          ...
          <div className="mx-auto max-w-4xl space-y-6 text-left">
            ...
            <section id="services">
              <article id="email">
                ...
                <p>
                  Target potential voters with personalized email messages. Our
                  platform enables segmentation and tracking to optimize
                  engagement.
                </p>
              </article>
              <article id="sms">
                ...
                <p>
                  Connect instantly with voters via SMS. High open rates ensure
                  your message is seen. Perfect for event reminders and quick
                  updates.
                </p>
              </article>
              <article id="legacy-mail">
                ...
                <p>
                  Maintain traditional appeal with direct mail. Send postcards,
                  flyers, and newsletters to reach voters in a personal way.
                </p>
              </article>
              <article id="forms">
                <h2 className="mt-4 font-bold">Online Forms</h2>
                <p>
                  Gather valuable voter information with custom online forms.
                  Ideal for volunteer sign-ups, surveys, and petitions.
                </p>
              </article>
              <article id="stats">
                <h2 className="mt-4 font-bold">Campaign Analytics</h2>
                <p>
                  Measure the success of your campaigns with our analytics
                  dashboard. Gain insights into voter behavior and campaign
                  performance.
                </p>
              </article>
            </section>
